...
const loadThreadClient = () => import('@/(app-shell)/thread/[...slug]/ThreadDetailClient');
const loadCategoryClient = () => import('@/(public)/category/[slug]/CategoryDiscussionClient');
const loadContentClient = () => import('@/(public)/content/[slug]/ContentDetailClient');
