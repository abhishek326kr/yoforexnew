...
const threadSchema = z.object({
  title: z
    ...
    .max(90, "Title must be at most 90 characters"),
  body: z
    .string()
  ...
  primaryKeyword: z
    .string()
    .max(50, "Primary keyword should be 1-6 words")
    .optional()
    .default(""),
  seoExcerpt: z
    .string()
    .max(160, "SEO excerpt must be at most 160 characters")
    .optional()
    .default(""),
  hashtags: z
    .array(z.string())
...
export default function ThreadCreationWizard({
  ...
  const handleSEOUpdate = useCallback(
    (data: SEOData) => {
      setSeoData(data);
  ...
  const onSubmit = (data: ThreadFormData) => {
    ...
    if (autoOptimizeSeo && seoData) {
      const mergedData = {
        ...
        hashtags:
          seoData.hashtags.length > 0 ? seoData.hashtags : data.hashtags,
              ...
              >
                <div className="text-center p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Join our community to share your knowledge and earn coins
                  </p>
                </div>
              </div>
            )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Use markdown to format your content (minimum 100
                            characters)
                          </FormDescription>
                          <FormControl>
                              ...
                              <div className="flex justify-between text-xs">
                                ...
                                {field.value.length >= 500 && (
                                  <span className="text-green-500 flex items-center gap-1">
                                    <Check className="h-3 w-3" /> Minimum length
                                    met
                                  </span>
                                )}
                              </div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            {/* Video Preview */}
                            {field.value &&
                              getVideoEmbedPreview(field.value) && (
                                <div className="mt-4">
                                  <iframe
                                    src={
                                      getVideoEmbedPreview(field.value) || ""
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            ...
                            >
                              {Object.entries(THREAD_TYPE_LABELS).map(
                                ([value, info]) => (
                                  <Label
                                    key={value}
                                    htmlFor={value}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Select the instruments relevant to your thread
                          </FormDescription>
                          <FormControl>
                            <div className="flex flex-wrap gap-2">
                              {INSTRUMENTS.map((instrument) => (
                                <Badge
                                  ...
                                  onClick={() => {
                                    const updated = field.value.includes(
                                      instrument,
                                    )
                                      ? field.value.filter(
                                          (i) => i !== instrument,
                            ...
                            <div className="flex flex-wrap gap-2">
                              {TIMEFRAMES.map((timeframe) => (
                                <Badge
                                  key={timeframe}
                                  variant={
                                    field.value.includes(timeframe)
                                      ? "default"
                                      : "outline"
                                  }
                                  className="cursor-pointer"
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Select relevant trading strategies
                          </FormDescription>
                          <FormControl>
                            <div className="flex flex-wrap gap-2">
                      ...
                      <CardContent>
                        <article className="space-y-4">
                          ...
                          <div className="flex flex-wrap gap-2">
                            <Badge>
                              {
                                THREAD_TYPE_LABELS[watchedFields.threadType]
                                  .label
                              }
                            </Badge>
                          ...
                          {watchedFields.videoEmbedUrl &&
                            getVideoEmbedPreview(
                              watchedFields.videoEmbedUrl,
                            ) && (
                              <iframe
                                src={
